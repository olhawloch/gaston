...
def compute_community_embeddings(text_emb_path, text_comm_path, community_nodes_path, output_path) -> dict:
    ...
    try:
        ...
        # Load the original community nodes file, which might contain labels.
...
def main():
    ...
    TEXT_EMBEDDINGS_PARQUET_PATH = os.path.join(DATA_PATH, "text_node_embeddings_xlnet.parquet")
    ...
    COMMUNITY_EMBEDDINGS_PARQUET_PATH = os.path.join(DATA_PATH, "avg_community_node_embeddings_xlnet.parquet")
    USER_EMB_OUT_NAME = "avg_user_node_embeddings_xlnet.parquet"
    USER_EMBEDDINGS_PARQUET_PATH = os.path.join(DATA_PATH, USER_EMB_OUT_NAME)
    ...
    print(f"\n--- AVG EMBEDDING GENERATION COMPLETE ({USER_EMB_OUT_NAME}) ---")
